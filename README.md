...
Create new migrations based on the changes in models: python3 manage.py makemigrations mail 
...
Future Additions
Change layout and add customizations for look of inbox and font options. 
